namespace OctoStyle.Core.Tests.Unit
{
    ...
    public static class DiffEntryListExtensionsTests
    {
        ...
        public static void ToGitDiffShouldReturnGitDiffForMultipleChunkDiff()
        {
            ...
            Assert.That(gitDiff[0].Position, Is.EqualTo(1));
            Assert.That(gitDiff[1], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[1].Position, Is.EqualTo(2));
            Assert.That(gitDiff[2], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[2].Position, Is.EqualTo(3));
            Assert.That(gitDiff[3], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[3].Position, Is.EqualTo(4));
            Assert.That(gitDiff[4], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[4].Position, Is.EqualTo(5));
            Assert.That(gitDiff[5], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[5].Position, Is.EqualTo(6));
            Assert.That(gitDiff[6], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[6].Position, Is.EqualTo(7));
            Assert.That(gitDiff[7], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[7].Position, Is.EqualTo(8));
            ...
            Assert.That(gitDiff[8].Position, Is.EqualTo(9));
            ...
            Assert.That(gitDiff[9].Position, Is.EqualTo(10));
            ...
            Assert.That(gitDiff[10].Position, Is.EqualTo(11));
            ...
            Assert.That(gitDiff[11].Position, Is.EqualTo(12));
            Assert.That(gitDiff[12], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[12].Position, Is.EqualTo(13));
            ...
            Assert.That(gitDiff[13].Position, Is.EqualTo(14));
            ...
            Assert.That(gitDiff[14].Position, Is.EqualTo(15));
            Assert.That(gitDiff[15], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[15].Position, Is.EqualTo(16));
            Assert.That(gitDiff[16], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[16].Position, Is.EqualTo(17));
            Assert.That(gitDiff[17], Is.TypeOf<EqualGitDiffEntry>());
            Assert.That(gitDiff[17].Position, Is.EqualTo(18));
        }
